...
namespace DPTS.Services.Blog
{
    ...
    public partial class BlogService : IBlogService
    {
        ...
        /// <returns>Blog posts</returns>
        public virtual IPagedList<BlogPost> GetAllBlogPosts(DateTime? dateFrom = null, DateTime? dateTo = null,
        ...
        public virtual IList<BlogPostTag> GetAllBlogPostTags(bool showHidden = false)
        {
        ...
        public virtual IList<BlogComment> GetAllComments(string visitorId = null, int? blogPostId = null,
            bool? approved = null, DateTime? fromUtc = null, DateTime? toUtc = null, string commentText = null)
        {
            ...
            if (!string.IsNullOrWhiteSpace(visitorId))
                query = query.Where(comment => comment.VisitorId == visitorId);
